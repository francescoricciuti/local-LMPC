...
function convhullStates(oldTraj::classes.OldTrajectory, posInfo::classes.PosInfo, mpcParams::classes.MpcParams,lapStatus::classes.LapStatus,selectedStates::classes.SelectedStates)
    ...
    selectedStates.selStates[i = 1:Np,j=1:4] = oldTraj.oldTraj[j=idx_s[1]:idx_s[1]+Np-1,i=1:4,selected_laps[1]]
    selectedStates.selStates[i=Np+1:2*Np,i=1:4] = oldTraj.oldTraj[i=idx_s[2]-N_points:idx_s[2]+Np-N_points-1,i=1:4,selected_laps[2]]  
