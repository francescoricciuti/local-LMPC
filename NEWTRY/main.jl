...
###########################################################################################################################################à
        ...
        #println("uCurr= ",[mpcSol.a_x mpcSol.d_f])
        ...
        #println("applied input at iteration $i = ",uCurr[i,:])
        zCurr_x[i+1,:]  = simModel_exact_dyn_x(zCurr_x[i,:],uCurr[i,:],modelParams)  # simulates the model with the inputs generated by the controller
        
        #println("zCurr($i +1)=",zCurr_x[i+1,:])
